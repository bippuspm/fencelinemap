...
raw=read.csv("~/TSCA/Fenceline Map/fencelinemap/DemographicImpactsofTRIv2.csv")
naics=read.xlsx("~/TSCA/Fenceline Map/fencelinemap/NAICS.xlsx")
weights=read.xlsx("~/TSCA/Fenceline Map/fencelinemap/TSCA Fenceline Map Chem Hazard Data Extraction_v2.xlsx",sheet=3,startRow = 2)
...
# Loop through demos and create new columns (getting error here)
for (v in demovars) {
...
#Export table
write.xlsx(st_drop_geometry(final), file = "~/TSCA/Fenceline Map/fencelinemap/TSCA_merged_v2.xlsx", rowNames = FALSE)

#Export shapefile
gdb_path <- "~/TSCA/Fenceline Map/fencelinemap/TSCA_facilitiesv2.gpkg"
